...
export default function ArtistStatisticPane(props: { id: number }) {
    ...
    const overallApi = useApi(getStatisticForArtist, true, undefined, undefined, id)
    const yearlyApi = useApi(getStatisticForArtist, true, undefined, undefined, id, new Date().getFullYear())
